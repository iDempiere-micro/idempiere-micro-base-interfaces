 ...
 * @version Release 5.1
 */
public interface Role extends PersistentObject {
    ...
    void setParentRole(@NotNull Role mRole);
    ...
    @NotNull
    List<Role> getIncludedRoles(boolean recursive);
    ...
    List<TableAccess> loadTableAccess(boolean reload);

    @Nullable
    List<ColumnAccess> loadColumnAccess(boolean reload);

    @Nullable
    List<RecordAccess> getRecordAccessArray();

    @Nullable
    List<RecordAccess> getRecordDependentAccessArray();
