 ...
 * @version Release 5.1
 */
public interface Table extends PersistentObject {
    ...
    ValidationRule getValRule() throws RuntimeException;
    ...
    @Nullable
    Column getColumn(@NotNull String columnName);
    ...
    @NotNull
    Column[] getColumns(boolean b);

    <T extends PersistentObject> TypedQuery<T> createQuery(String s);
}
